...
namespace SistemaSatHospitalario.Core.Application.Common.Interfaces
{
    public interface IApplicationDbContext
    {
        ...
        DbSet<CategoriaInsumo> CategoriasInsumo { get; }
        ...
        DbSet<AreaClinica> AreasClinicas { get; }
        DbSet<StockSede> StocksSedes { get; }
        DbSet<PedidoInterSede> PedidosInterSede { get; }
