...
namespace SistemaSatHospitalario.Core.Application.Common.Interfaces
{
    public interface INotificationService
    {
        ...
        Task CreatePersistentNotificationAsync(string title, string message, string type, Guid? targetUserGuidId = null, string? targetRole = null, string? actionUrl = null, CancellationToken ct = default);
