        ...
        public async Task InitializeAsync()
        {
            try
            {
                ...
                try
                {
                    ...
                    // 5. Autocreación auto-curativa de Proveedores, OrdenesCompraInventario y PagosProveedores si no existen
                    if (isSqlite)
                    {
                        await _context.Database.ExecuteSqlRawAsync(@"
                            ...
                            CREATE UNIQUE INDEX IF NOT EXISTS `IX_Proveedores_RIF` ON `Proveedores` (`RIF`);
                            ...
                            CREATE TABLE IF NOT EXISTS `OrdenesCompraInventario` (
                                ...
                                `MontoTotalUSD` REAL NOT NULL,
                                `MontoAbonadoUSD` REAL NOT NULL,
                                `MontoPendienteUSD` REAL NOT NULL,
                                `Estado` TEXT NOT NULL,
                                `TasaCambioBs` REAL NOT NULL,
                    ...
                    else
                    {
                        await _context.Database.ExecuteSqlRawAsync(@"
                            ...
                            CREATE TABLE IF NOT EXISTS `OrdenesCompraInventario` (
                                ...
                                `MontoPendienteUSD` DECIMAL(18,2) NOT NULL,
                                `Estado` VARCHAR(50) NOT NULL,
                                `TasaCambioBs` DECIMAL(18,4) NOT NULL,
