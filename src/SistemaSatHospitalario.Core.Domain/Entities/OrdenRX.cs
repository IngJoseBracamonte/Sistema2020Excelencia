...
namespace SistemaSatHospitalario.Core.Domain.Entities
{
    public class OrdenRX : OrdenDeServicio
    {
        ...
        public OrdenRX(int numeroLlegada, Guid pacienteId, string tipoIngreso, string estudioSolicitado, Guid asistenteId, int? convenioId = null) 
            : base(numeroLlegada, pacienteId, tipoIngreso, convenioId)
        {
