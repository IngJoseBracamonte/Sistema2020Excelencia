# Análisis: `CuentaServicios.UsuarioAuditoria`
...
- [ ] 1. Identificar todos los usos de `CuentaServicios.UsuarioAuditoria` (grep).
...
- `dotnet build` sin CS0618 para `CuentaServicios.UsuarioAuditoria`.
- La auditoría de cuentas muestra el usuario correcto.
