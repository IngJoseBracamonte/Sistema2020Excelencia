# Análisis: `CuentaServicios.UsuarioCarga`
...
- [ ] 1. Identificar todos los usos de `CuentaServicios.UsuarioCarga`.
...
- `dotnet build` sin CS0618 para `CuentaServicios.UsuarioCarga`.
- Los reportes de auditoría muestran el usuario de carga correcto.

## 6. Riesgos

- Requiere backfill de `UsuarioCargaId` para cuentas legacy.