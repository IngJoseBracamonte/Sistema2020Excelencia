...
{
    public partial class TotalFacturadoPorPersona : Form
    {
        public TotalFacturadoPorPersona()
        {
            InitializeComponent();
        }
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            ds.Clear();
            ds = Conexion.TotalFacturadoPorOrden(cmd, cmd2);
        ...
        private void TotalFacturadoPorPersona_Load(object sender, EventArgs e)
        {
