...
namespace Laboratorio
{
    public partial class Analisis : Form
    {
        ...
        private void Hematologia(PdfSharp.Pdf.PdfDocument document)
        {
            ...
            XFont fontRegular2 = new XFont(facename, 13, XFontStyle.Regular);
            Double PosicionP = 90;
            ...
            fontRegular = new XFont(facename, 9, XFontStyle.Regular);
            PosicionP = 90;
            ...
            foreach (DataRow r in Form22.data.Tables[0].Rows)
            {

                if (IdOrden != r["IdOrden"].ToString())
                {
                    int numberOfRecords = Form22.data.Tables[0].AsEnumerable().Where(x => x["IdOrden"].ToString() == r["IdOrden"].ToString()).ToList().Count;
